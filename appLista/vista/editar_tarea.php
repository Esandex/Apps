...
<html>
    ...
    <div class ="maik">   
        <form action ="../controlador/editar.php" method ="POST">
            <h3 class = "title">Edita Tu Tarea...</h3>
            <p>Titulo De la Tarea</p><input title="Se necesita el titulo del deseo" type = "text" id ="jinx" name="title" required>
                ...
                <input type="reset" value="Limpiar" class ="uno"> <button type="button" id="actualizar" class="uno">Actualizar Tarea</button>
        </form>     
    </div>  
    </center>
